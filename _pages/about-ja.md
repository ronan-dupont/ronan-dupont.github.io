...
<section class="research-hero">
  <p class="research-kicker">応用数学 · 科学技術計算 · 数値線形代数</p>
  <p>応用数学のポスドク研究者として、現在は数値線形代数、反復法、科学技術計算に取り組んでいます。これまでには沿岸地形力学やVirtual Element Methodに関する研究も行ってきました。</p>
  <div class="research-actions">
    <a class="btn btn--primary" href="/ja/publications/">研究業績を見る</a>
    <a class="btn" href="/cv-ja/">CVを見る</a>
  </div>
</section>
