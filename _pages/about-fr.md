...
<section class="research-hero">
  <p class="research-kicker">Mathématiques appliquées · Calcul scientifique · Algèbre linéaire numérique</p>
  <p>Je suis chercheur postdoctoral en mathématiques appliquées, avec des travaux actuels en algèbre linéaire numérique, méthodes itératives et calcul scientifique, et des recherches antérieures en morphodynamique côtière et méthodes des éléments virtuels.</p>
  <div class="research-actions">
    <a class="btn btn--primary" href="/fr/publications/">Voir les publications</a>
    <a class="btn" href="/cv-fr/">Télécharger le CV</a>
  </div>
</section>
